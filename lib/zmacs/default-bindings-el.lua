...
(global-set-key "\C-h\C-c" 'describe-copying)
(global-set-key "\F1\C-c" 'describe-copying)
...
(global-set-key "\C-h\C-w" 'describe-no-warranty)
(global-set-key "\F1\C-w" 'describe-no-warranty)
...
(global-set-key "\C-hn" 'view-emacs-news)
(global-set-key "\C-h\C-n" 'view-emacs-news)
(global-set-key "\F1n" 'view-emacs-news)
(global-set-key "\F1\C-n" 'view-emacs-news)
